...
def crop_resize_data(image, offset):
    train_image = image[offset:, :]
    return train_image
...
class TusimpleSet(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # we could split the instance gt_image_binary here, each instance in one channel (basically a binary mask for each)
